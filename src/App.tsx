      ...
      <div className="page">
        ...
        <section className="sec sec-border">
          ...
          >
            ...
            >
              <div className="ct">
                <div className="ci" style={{ background: 'rgba(232,93,58,.12)' }}>🤝</div>
                <span className="badge bl"><span className="bd"></span>Live</span>
              </div>
            ...
            >
              <div className="ct">
                <div className="ci" style={{ background: 'rgba(91,141,239,.12)' }}>📖</div>
                <span className="badge bl"><span className="bd"></span>Live</span>
              </div>
            ...
            >
              <div className="ct">
                <div className="ci" style={{ background: 'rgba(76,175,130,.12)' }}>✍️</div>
                <span className="badge bl"><span className="bd"></span>Live</span>
              </div>
            ...
            <motion.div className="card" variants={cardChild}>
              <div className="ct">
                <div className="ci" style={{ background: 'rgba(212,168,83,.12)' }}>🗼</div>
                <span className="badge bb"><span className="bd"></span>Building</span>
              </div>
        ...
        >
          <div className="about-grid">
            <div className="about-text">
              <h2>One engineer, building focused tools from Tokyo.</h2>
              <p>Kyren follows Kanso — the Japanese principle of simplicity. Strip away the unnecessary. Leave only what matters. Every tool does one thing well.</p>
              <p>No investor decks. No feature bloat. Just tools that solve real problems, shipped when they're ready.</p>
            ...
            <div className="stack">
              <div className="stack-cat"><div className="scl">Frontend</div><div className="sci"><span className="st">Next.js</span><span className="st">React</span><span className="st">TypeScript</span><span className="st">Tailwind</span></div></div>
              <div className="stack-cat"><div className="scl">Backend</div><div className="sci"><span className="st">Supabase</span><span className="st">PostgreSQL</span><span className="st">Stripe</span></div></div>
              <div className="stack-cat"><div className="scl">AI</div><div className="sci"><span className="st">Claude API</span><span className="st">RAG</span></div></div>
              <div className="stack-cat"><div className="scl">Infra</div><div className="sci"><span className="st">Vercel</span><span className="st">GitHub Actions</span></div></div>
            </div>
          </div>
        </motion.section>
      </div>
